...
object SignInApiService {
    ...
    suspend fun renewToken(
        ...
        return try {
            val response: HttpResponse = com.example.myapplicationnewtest.check_in_out.data.httpClient.post("https://ahmedelzupeir-androidapp21.odoo.com/api/employee/renew_token") {
