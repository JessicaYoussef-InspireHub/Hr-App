...
fun AnalyticDistribution(){
    ...
    var selectedAnalyticDistribution by remember { mutableStateOf("") }

    val colors = appColors()

    val analyticDistribution = listOf(
        ""
    )
    ...
    ExposedDropdownMenuBox(
        ...
        TextField(
            value = selectedAnalyticDistribution,
            onValueChange = {},
            readOnly = true,
            placeholder = {
                Text(
        ...
        ExposedDropdownMenu(
            ...
            analyticDistribution.forEach { option ->
                DropdownMenuItem(
                    text = {
                        Text(
                            option,
                    ...
                    onClick = {
                        selectedAnalyticDistribution = option
                        expanded = false
                    }
                )
            }
