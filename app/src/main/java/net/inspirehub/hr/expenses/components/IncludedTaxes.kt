...
fun IncludedTaxes(
    ...
    var selectedTaxes by remember { mutableStateOf(listOf<Tax>()) }

    val colors = appColors()

    val taxAmount = remember(selectedTaxes, amount) {
        selectedTaxes.sumOf { tax -> amount * tax.amount / 100 }
    }
    ...
    Column(
                ...
                if (taxes.isEmpty()) {
                    ...
                    taxes.forEach { tax ->
                        DropdownMenuItem(
                            ...
                            onClick = {
                                selectedTaxes = if (selectedTaxes.contains(tax)) {
                                    selectedTaxes - tax
                                } else {
                                    selectedTaxes + tax
                                }
        ...
        TextField(
            value = String.format("%.2f LE", taxAmount),
            onValueChange = {},
            readOnly = true,
            singleLine = true,
            modifier = Modifier.fillMaxWidth(),
