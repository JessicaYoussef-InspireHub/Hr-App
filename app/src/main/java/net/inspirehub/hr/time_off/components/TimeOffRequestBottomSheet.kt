...
fun TimeOffRequestBottomSheet(
    ...
    val showTimePicker =
        (permissionChecked || selectedLeaveType?.request_unit == "hours_only") && !shouldHideTimePicker

    val duration30 = stringResource(R.string.duration_30_minutes)
    var selectedPermissionDuration by remember {
        mutableStateOf(
            PermissionDuration(
                title = duration30,
                hours = 0.5
                ...
                if (selectedLeaveType != null) {
                    ...
                    SmallButtons(
                        onConfirm = {
                            ...
                            Log.d(
                                "Jessica SAVE",
                                "selectedPermissionPeriod = $selectedPermissionPeriod"
                            )
                            Log.d(
                                "Jessica SAVE",
                            ...
                            Log.d(
                                "Jessica SAVE",
                                "enable_leave_time_slot = ${selectedLeaveType?.enable_leave_time_slot}"
                            )
                            Log.d(
                                "Jessica SAVE",
                                "request_unit = ${selectedLeaveType?.request_unit}"
                            )
                            ...
                            if (permissionChecked || selectedLeaveType?.request_unit == "hours_only") {
                                ...
                                CoroutineScope(Dispatchers.IO).launch {
                                    ...
                                    val fromHourForApi =
                                        convertSelectedTimeToHour24(selectedFromHour)
                                    ...
                                    val request = TimeOffRequestForRequestEmployee(
                                        ...
                                        permission_period = getPermissionPeriodValue(
                                            selectedPermissionPeriod
                                        ),
                                    ...
                                    Log.d(
                                        "PERIOD Jessica",
                                        getPermissionPeriodValue(selectedPermissionPeriod)
                                    )
